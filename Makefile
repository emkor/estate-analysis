...
render:
	...
	@$(VENV_PY3) src/render_popc.py "data/uke/popc/0214_POPC.csv" "data/0214_POPC.json"
	@$(VENV_PY3) src/render_popc.py "data/uke/popc/0215_POPC.csv" "data/0215_POPC.json"
	@$(VENV_PY3) src/render_popc.py "data/uke/popc/0218_POPC.csv" "data/0218_POPC.json"
	@$(VENV_PY3) src/render_popc.py "data/uke/popc/0220_POPC.csv" "data/0220_POPC.json"
